...
from .choices import LEVEL_CHOICES,Is_Important_CHOICES,OCCURRENCE_CHOICES,OU_CHOICES,DEPARTMENT_CHOICES,User_Choices,google_api
import reversion
from geoposition.fields import GeopositionField
from Auditable.models import Auditable_Category,Auditable_Introduction,Auditable_Subintroduction,Auditable_Task,Auditable_Subtask,Auditable_Troubleshoot,Auditable_Subtroubleshoot,Auditable_Fpe,Auditable_Worklocation
...
class Worklocation(Auditable_Worklocation):
	...
	def __str__(self):
		return self.location_building + ' - ' + str(self.location_floor)
reversion.register(Worklocation)
...
class Userdetail(models.Model):
	...
	organization = models.CharField(max_length=250,choices=OU_CHOICES,null=True, blank=True)
	...
	likes_to_play = models.CharField(max_length=250,null=True, blank=True)
	likes_to_eat = models.CharField(max_length=250,null=True, blank=True)
...
class Fpe(Auditable_Fpe):
	...
	check_cancle_service = models.BooleanField(blank= True)
	check_change = models.BooleanField(blank= True)
